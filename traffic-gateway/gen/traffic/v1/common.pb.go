...
const file_traffic_v1_common_proto_rawDesc = "" +
	...
	"\x14SESSION_STATUS_ERROR\x10\x04B\xab\x01\n" +
	"\x0ecom.traffic.v1B\vCommonProtoP\x01ZCgithub.com/nikitak/parsing/traffic-gateway/gen/traffic/v1;trafficv1\xa2\x02\x03TXX\xaa\x02\n" +
	"Traffic.V1\xca\x02\n" +
