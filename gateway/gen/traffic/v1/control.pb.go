...
const file_traffic_v1_control_proto_rawDesc = "" +
	...
	"\x06detail\x18\x03 \x01(\tR\x06detail\"\xfc\x01\n" +
...
var file_traffic_v1_control_proto_goTypes = []any{
	...
	(SourceKind)(0),                      // 57: traffic.v1.SourceKind
	(*Session)(nil),                      // 58: traffic.v1.Session
	(*Tag)(nil),                          // 59: traffic.v1.Tag
	(*Group)(nil),                        // 60: traffic.v1.Group
	(*DecodeProgress)(nil),               // 61: traffic.v1.DecodeProgress
	(*Comment)(nil),                      // 62: traffic.v1.Comment
}
var file_traffic_v1_control_proto_depIdxs = []int32{
	...
	57, // 10: traffic.v1.StartCaptureRequest.source_kind:type_name -> traffic.v1.SourceKind
	56, // 11: traffic.v1.StartCaptureRequest.params:type_name -> traffic.v1.StartCaptureRequest.ParamsEntry
	58, // 12: traffic.v1.StopCaptureResponse.session:type_name -> traffic.v1.Session
	58, // 13: traffic.v1.ImportSessionResponse.session:type_name -> traffic.v1.Session
	58, // 14: traffic.v1.ImportCaptureResponse.session:type_name -> traffic.v1.Session
	59, // 15: traffic.v1.TagList.tags:type_name -> traffic.v1.Tag
	60, // 16: traffic.v1.GroupList.groups:type_name -> traffic.v1.Group
	3,  // 17: traffic.v1.ControlService.ListCaptureSources:input_type -> traffic.v1.Empty
	13, // 18: traffic.v1.ControlService.DescribeCaptureSource:input_type -> traffic.v1.DescribeCaptureSourceRequest
	21, // 19: traffic.v1.ControlService.StartCapture:input_type -> traffic.v1.StartCaptureRequest
	23, // 20: traffic.v1.ControlService.StopCapture:input_type -> traffic.v1.StopCaptureRequest
	36, // 21: traffic.v1.ControlService.ReDecode:input_type -> traffic.v1.ReDecodeRequest
	...
	3,  // 25: traffic.v1.ControlService.ListLogs:input_type -> traffic.v1.Empty
	9,  // 26: traffic.v1.ControlService.GetLog:input_type -> traffic.v1.GetLogRequest
	25, // 27: traffic.v1.ControlService.ExportSession:input_type -> traffic.v1.ExportSessionRequest
	27, // 28: traffic.v1.ControlService.SetSessionGroup:input_type -> traffic.v1.SetSessionGroupRequest
	28, // 29: traffic.v1.ControlService.SetSessionLabel:input_type -> traffic.v1.SetSessionLabelRequest
	29, // 30: traffic.v1.ControlService.DeleteSession:input_type -> traffic.v1.DeleteSessionRequest
	30, // 31: traffic.v1.ControlService.ImportSession:input_type -> traffic.v1.ImportChunk
	34, // 32: traffic.v1.ControlService.GetSessionArtifacts:input_type -> traffic.v1.GetSessionArtifactsRequest
	32, // 33: traffic.v1.ControlService.ImportCapture:input_type -> traffic.v1.ImportCaptureRequest
	37, // 34: traffic.v1.ControlService.CreateTag:input_type -> traffic.v1.CreateTagRequest
	38, // 35: traffic.v1.ControlService.DeleteTag:input_type -> traffic.v1.DeleteTagRequest
	39, // 36: traffic.v1.ControlService.ListTags:input_type -> traffic.v1.ListTagsRequest
	41, // 37: traffic.v1.ControlService.SetTags:input_type -> traffic.v1.SetTagsRequest
	42, // 38: traffic.v1.ControlService.ToggleFavorite:input_type -> traffic.v1.ToggleFavoriteRequest
	43, // 39: traffic.v1.ControlService.AddComment:input_type -> traffic.v1.AddCommentRequest
	44, // 40: traffic.v1.ControlService.EditComment:input_type -> traffic.v1.EditCommentRequest
	45, // 41: traffic.v1.ControlService.DeleteComment:input_type -> traffic.v1.DeleteCommentRequest
	46, // 42: traffic.v1.ControlService.SetMark:input_type -> traffic.v1.SetMarkRequest
	47, // 43: traffic.v1.ControlService.ClearMark:input_type -> traffic.v1.ClearMarkRequest
	48, // 44: traffic.v1.ControlService.CreateGroup:input_type -> traffic.v1.CreateGroupRequest
	49, // 45: traffic.v1.ControlService.UpdateGroup:input_type -> traffic.v1.UpdateGroupRequest
	50, // 46: traffic.v1.ControlService.DeleteGroup:input_type -> traffic.v1.DeleteGroupRequest
	51, // 47: traffic.v1.ControlService.ListGroups:input_type -> traffic.v1.ListGroupsRequest
	53, // 48: traffic.v1.ControlService.SetGroups:input_type -> traffic.v1.SetGroupsRequest
	11, // 49: traffic.v1.ControlService.ListCaptureSources:output_type -> traffic.v1.CaptureSourceList
	15, // 50: traffic.v1.ControlService.DescribeCaptureSource:output_type -> traffic.v1.SourceDescriptor
	22, // 51: traffic.v1.ControlService.StartCapture:output_type -> traffic.v1.StartCaptureResponse
	24, // 52: traffic.v1.ControlService.StopCapture:output_type -> traffic.v1.StopCaptureResponse
	61, // 53: traffic.v1.ControlService.ReDecode:output_type -> traffic.v1.DecodeProgress
	5,  // 54: traffic.v1.ControlService.ListServices:output_type -> traffic.v1.ServiceList
	6,  // 55: traffic.v1.ControlService.StartService:output_type -> traffic.v1.ServiceInfo
	3,  // 56: traffic.v1.ControlService.StopService:output_type -> traffic.v1.Empty
	7,  // 57: traffic.v1.ControlService.ListLogs:output_type -> traffic.v1.LogList
	10, // 58: traffic.v1.ControlService.GetLog:output_type -> traffic.v1.LogChunk
	26, // 59: traffic.v1.ControlService.ExportSession:output_type -> traffic.v1.ExportChunk
	3,  // 60: traffic.v1.ControlService.SetSessionGroup:output_type -> traffic.v1.Empty
	3,  // 61: traffic.v1.ControlService.SetSessionLabel:output_type -> traffic.v1.Empty
	3,  // 62: traffic.v1.ControlService.DeleteSession:output_type -> traffic.v1.Empty
	31, // 63: traffic.v1.ControlService.ImportSession:output_type -> traffic.v1.ImportSessionResponse
	35, // 64: traffic.v1.ControlService.GetSessionArtifacts:output_type -> traffic.v1.SessionArtifacts
	33, // 65: traffic.v1.ControlService.ImportCapture:output_type -> traffic.v1.ImportCaptureResponse
	59, // 66: traffic.v1.ControlService.CreateTag:output_type -> traffic.v1.Tag
	3,  // 67: traffic.v1.ControlService.DeleteTag:output_type -> traffic.v1.Empty
	40, // 68: traffic.v1.ControlService.ListTags:output_type -> traffic.v1.TagList
	3,  // 69: traffic.v1.ControlService.SetTags:output_type -> traffic.v1.Empty
	3,  // 70: traffic.v1.ControlService.ToggleFavorite:output_type -> traffic.v1.Empty
	62, // 71: traffic.v1.ControlService.AddComment:output_type -> traffic.v1.Comment
	62, // 72: traffic.v1.ControlService.EditComment:output_type -> traffic.v1.Comment
	3,  // 73: traffic.v1.ControlService.DeleteComment:output_type -> traffic.v1.Empty
	3,  // 74: traffic.v1.ControlService.SetMark:output_type -> traffic.v1.Empty
	3,  // 75: traffic.v1.ControlService.ClearMark:output_type -> traffic.v1.Empty
	60, // 76: traffic.v1.ControlService.CreateGroup:output_type -> traffic.v1.Group
	60, // 77: traffic.v1.ControlService.UpdateGroup:output_type -> traffic.v1.Group
	3,  // 78: traffic.v1.ControlService.DeleteGroup:output_type -> traffic.v1.Empty
	52, // 79: traffic.v1.ControlService.ListGroups:output_type -> traffic.v1.GroupList
	3,  // 80: traffic.v1.ControlService.SetGroups:output_type -> traffic.v1.Empty
